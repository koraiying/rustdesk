...
pub const RENDEZVOUS_SERVERS: &[&str] = &["esxi.whiteyes.cn"];
pub const RS_PUB_KEY: &str = "M9Ltsv3gTT03dO1RpguF1GO+ee34tS9WM76940rkxnI=";

pub const RENDEZVOUS_SERVER_PORTPPPPPPP: i32 = 21116;
